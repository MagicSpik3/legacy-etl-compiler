...
digraph {
  ...
  subgraph cluster_graph {
    ...
    # 1. Increase margin to add space between nodes and the green border
    # Format: "horizontal,vertical" in inches
    margin=5; 

    # 2. Set global node dimensions to push the cluster boundaries out
    node [shape=box, fontsize=28, fillcolor="white", style=filled, width=3, height=1.5];
